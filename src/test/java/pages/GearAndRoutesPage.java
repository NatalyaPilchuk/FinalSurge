...
public class GearAndRoutesPage extends BasePage {
    ...
    private By theNameOfShoes = By.xpath("//td[contains(@style,'width: 60px;')]//following::strong[1]");
private By getTakeNameOfShoes=By.xpath("//div[contains(@class,'formSep')]//input[@name='ShoeName']");
    ...
    public void inputFields() {
        ...
        driver.findElement(shoeName).sendKeys(FakeMessageGenerator.generateLastName());
